...
public class MovieUtility {
    ...
    public static void printShorterMovieName(Movie movieObj1, Movie movieObj2) {
        ...
        System.out.println(movieObj1.getLength() > movieObj2.getLength() ?
                movieObj2.getName() : movieObj1.getName());
    ...
    public static List<Movie> getMyFavoriteMovies() {
        ...
        //TODO YOUR CODE HERE
        movieLst.add(new Movie("Dcitator", 2.3, "Comedy"));
        movieLst.add(new Movie("Frozen2", 1.5, "Family"));
        movieLst.add(new Movie("Pursuit of Happiness", 2.0, "Drama"));
        movieLst.add(new Movie("Batman", 2.3, "Action"));
        movieLst.add(new Movie("Aladdin", 2.7, "Family"));
        return movieLst;
    }
