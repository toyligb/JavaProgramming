...
public class HR_Staff {
    ...
    public static void main(String[] args) {
        ...
        Employee e1 = new HourlyEmployee("Toyly", 7, 65, 2500);
//        e1.calculateAnnualSalary();
//
//        e1 = new FullTimeEmployee("Jemal", 120, 12000);
//        e1.calculateAnnualSalary();

        Employee e2 = new HourlyEmployee("Beza", 165, 57, 2080);
        Employee e3 = new FullTimeEmployee("Tony", 4, 15000);
