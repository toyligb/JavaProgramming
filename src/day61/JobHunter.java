...
public class JobHunter {
    ...
    public static void main(String[] args) {
        ...
        myFavJobs.add(new Job("Orangevale", 120000, "DdsTech"));
        myFavJobs.add(new Job("GA", 110000, "Amazon"));
        myFavJobs.add(new Job("VA", 140000, "FaceBook"));
        myFavJobs.add(new Job("NY", 150000, "Apple"));
        ...
        System.out.println("myFavJobs after reversing = " + myFavJobs);
