...
public class FastFoodRestaurants {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Popeyes count = " + popeyesCount);
        System.out.println("Dominos count = " + dominosCount);
        System.out.println("TacoBell count = " + tacoBellCount);
        ...
        for (String eachRest : restaurants) {
            if (eachRest.contains("McDonald's") && eachRest.contains("TX")) {
                System.out.println((countMcDonaldsTX+1) + ". McDonald's TX: " + eachRest);
                countMcDonaldsTX++;
            }
        }
        System.out.println("countMcDonaldsTX = " + countMcDonaldsTX);
        ...
        for (int x = 0; x < restaurants.length; x++) {
            String[] restSplit = restaurants[x].split(",");
            System.out.println((x+1) + ". " + restSplit[2] + " -> " + restSplit[1] + ", " + restSplit[4]);
        }
